...
////        drive.angleLockBool = (outtake.arm.armState == Outtake.Arm.STATE.GRABBING_CLIP) || (outtake.arm.armState == Outtake.Arm.STATE.SCORING_CLIP);
...
//        if (outtake.arm.armState == Outtake.Arm.STATE.SCORING_BUCKET) {
...
//                ));
//            }
//        } else if (outtake.arm.armState == Outtake.Arm.STATE.SCORING_CLIP) {
...
//                ));
//            }
//        } else if (outtake.arm.armState == Outtake.Arm.STATE.GRABBING_CLIP) {
//            if (currentGamepad1.left_bumper && !previousGamepad1.left_bumper) {
...
//                ));
//            }
//        } else if (outtake.arm.armState == Outtake.Arm.STATE.TRANSFER) {
