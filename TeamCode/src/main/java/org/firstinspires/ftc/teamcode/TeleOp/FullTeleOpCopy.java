...
//        hang.initialize(this, robotHardware);
    ...
    public void loop() {
        ...
        drive.angleLockBool = (outtake.armPitch.armPos == ExtendingOuttake.ArmPitch.STATE.GRABBING_CLIP) || (outtake.armPitch.armPos == ExtendingOuttake.ArmPitch.STATE.SCORING_CLIP);
        ...
        if (outtake.armPitch.armPos == ExtendingOuttake.ArmPitch.STATE.SCORING_BUCKET) {
        ...
        } else if (outtake.armPitch.armPos == ExtendingOuttake.ArmPitch.STATE.SCORING_CLIP) {
        ...
        } else if (outtake.armPitch.armPos == ExtendingOuttake.ArmPitch.STATE.GRABBING_CLIP) {
            if (currentGamepad1.left_bumper && !previousGamepad1.left_bumper) {
        ...
        } else if (outtake.armPitch.armPos == ExtendingOuttake.ArmPitch.STATE.STOW) {
